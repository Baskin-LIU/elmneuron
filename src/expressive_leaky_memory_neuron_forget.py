...
class ELMf(jit.ScriptModule):
    """Expressive Leaky Memory (ELM) neuron model with forget gate to emulate reset."""
    ...
    def __init__(
        ...
        self.tau_b = nn.parameter.Parameter(tau_b, requires_grad=learn_memory_tau)
